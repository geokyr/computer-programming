...
/*
Εκφώνηση
Να γράψετε ένα πρόγραμμα που να διαβάζει έναν φυσικό αριθμό N >= 10 και να 
εκτυπώνει το άθροισμα των δύο τελευταίων ψηφίων του.

Για παράδειγμα, αν N=4217, θα πρέπει να εκτυπώνεται ο αριθμός 8 (γιατί 1+7=8).

Δεδομένα εισόδου
Μόνο μία γραμμή που θα περιέχει τον αριθμό Ν. Θεωρήστε δεδομένο ότι θα είναι 
